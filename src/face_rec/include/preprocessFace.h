...
void detectBothEyes(const Mat &face, CascadeClassifier &eyeCascade1, CascadeClassifier &eyeCascade2, CascadeClassifier &eyeCascade3, Point &leftEye, Point &rightEye, vector<Rect> *searchedLeftEye = NULL, vector<Rect> *searchedRightEye = NULL);
